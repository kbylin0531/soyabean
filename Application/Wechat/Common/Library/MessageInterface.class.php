...
use Application\Wechat\Common\Library\WXBiz\WXBizMsgCrypt;
use Kbylin\System\Utils\Network;

/**
 * Class MessageInterface 消息处理接口
...
//------------------------------------- 被动回复用户消息 ---------------------------------------------------------------------------//
    ...
    <Content><![CDATA[%s]]></Content></xml>', $this->FromUserName, $this->ToUserName, REQUEST_TIME, $content);
        return $result;
    }
...
<Image><MediaId><![CDATA[%s]]></MediaId></Image></xml>', $this->FromUserName, $this->ToUserName, REQUEST_TIME,$MediaId);
        return $result;
    }
...
<CreateTime>%s</CreateTime>
<MsgType><![CDATA[%s]]></MsgType>
<Voice><MediaId><![CDATA[%s]]></MediaId></Voice></xml>', $this->FromUserName, $this->ToUserName, REQUEST_TIME,$MediaId);
        return $result;
    }
...
//        $url = 'https://api.weixin.qq.com/cgi-bin/user/info?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN';
    ...
    protected function _replyData(array $msg, $msgType) {
        ...
        $sTimeStamp = REQUEST_TIME;
        $sNonce = 'encrypt_nonce';
